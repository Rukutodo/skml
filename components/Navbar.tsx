...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Logo */}
        <a href="#" style={{ display: "flex", alignItems: "center", gap: "0.75rem", flexShrink: 0, textDecoration: "none" }} id="navbar-logo">
          <div
            style={{
              position: "relative",
              overflow: "hidden",
          ...
          <div
            className="logo-text hidden sm:flex"
            style={{
        ...
        {/* Right group: WhatsApp + Hamburger */}
