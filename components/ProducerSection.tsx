        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "3rem", alignItems: "center" }} className="producer-grid">
          ...
          <div className="scroll-reveal-left">
            <div style={{
              ...
              <Image
                src="/assets/images/producer-portrait.jpeg"
                alt="Kandregula Adhinarayana — Founder of SKML Motion Pictures"
                fill
          ...
          <div className="scroll-reveal-right">
            <h2 style={{ fontFamily: "var(--font-playfair), serif", fontSize: "clamp(2rem, 4vw, 3.25rem)", fontWeight: 700, lineHeight: 1.15, letterSpacing: "-0.02em", color: "#ffffff" }}>
              Kandregula
              <br />
              <span style={{ fontWeight: 400, fontStyle: "italic", color: "rgba(255,255,255,0.4)" }}>Adhinarayana</span>
            </h2>
            ...
            <div style={{ marginTop: "2.5rem", display: "flex", flexDirection: "column", gap: "1.25rem" }}>
              <p style={{ fontSize: "15px", lineHeight: 1.85, color: "rgba(255,255,255,0.6)" }}>
                With a deep passion for cinema and a visionary approach to filmmaking,
                Kandregula Adhinarayana founded SKML Motion Pictures in 2018.
                His journey in the film industry began with a simple belief —
                that great stories deserve to be told, regardless of budget constraints.
              </p>
              <p style={{ fontSize: "15px", lineHeight: 1.85, color: "rgba(255,255,255,0.6)" }}>
                Under his leadership, SKML has produced over 6 feature films and
                successfully navigated OTT distribution across major platforms
                including Amazon Prime Video and Aha.
              </p>
              <p style={{ fontSize: "15px", lineHeight: 1.85, color: "rgba(255,255,255,0.6)" }}>
                Adhinarayana continues to champion affordable production solutions,
                making cinema accessible to emerging directors and storytellers
                who share his vision for impactful storytelling.
              </p>
            </div>
            ...
            <div style={{ marginTop: "2.5rem", display: "flex", alignItems: "center", gap: "1.25rem" }}>
              ...
              <span style={{ fontFamily: "var(--font-playfair), serif", fontSize: "1.125rem", fontStyle: "italic", color: "rgba(255,255,255,0.3)" }}>
                &ldquo;Every story deserves its screen.&rdquo;
              </span>
            </div>
          </div>
        </div>
