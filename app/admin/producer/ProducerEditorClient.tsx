    ...
    <div style={{maxWidth:880, margin:"0 auto"}}>
      <div style={{display:"flex",alignItems:"flex-start",justifyContent:"space-between",marginBottom:"1.75rem",flexWrap:"wrap",gap:"1rem"}}>
        <div>
          ...
          <h1 className="pg-t" style={{fontSize:"1.5rem", marginTop: 0}}>Founder Profile</h1>
          <p className="pg-sub" style={{marginTop: ".25rem"}}>Update the producer / founder section on your site.</p>
        </div>
